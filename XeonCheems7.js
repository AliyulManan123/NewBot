...
let { key } = await XeonBotInc.sendMessage(from, {text: 'LOADING...'})//Pengalih isu
...
XeonBotInc.sendMessage(from, { text : `Hi @${sender.split("@")[0]}, Itu kak ownerku namanya ihsan, Save aja gak gigit kok, Tapi ingat jangan dispam!!!😇`, mentions: [sender]}, { quoted: repf })
}
break
        case 'thanks':
case 'terimakasih':
...
case 'bott': case 'bot?': case 'list': case 'menu': case 'bot': case '?': {
            ...
            xeonezy = `_Hai kak ${pushname}_ 👋\n_Kenalin saya ${global.botname}_\n_Tolong jangan spam ya!!_
            
• Nama bot : *${global.botname}*
• Owner : _${global.ownernumber}_
• Versi : *1.0.0*
• Type baileys : *MultiDevice*
...
*Follow IGE Owner Gamtenk* : *Ikhsan ✆*
_instagram.com/malasnulisnamapengguna_
...
me = m.sender
teks = `*Waduhh, Hubungi owner untuk berdonasi Terima Kasih*!!`
sendXeonBotIncMessage(from, { 
text: teks,
mentions:[sender],
contextInfo:{
